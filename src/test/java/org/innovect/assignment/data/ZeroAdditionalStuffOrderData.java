...
public class ZeroAdditionalStuffOrderData {
	...
	private static List<OrderPizzaDTO> createOrderPizzaDTOList(){
		...
		/*
		 * List<OrderAdditionalStuffDTO> orderAdditionalStuffDTOList = new
		 * ArrayList<>(); OrderAdditionalStuffDTO orderAdditionalStuffDTO1 = new
		 * OrderAdditionalStuffDTO("Black olive", "Veg Toppings", 20.0, 9);
		 * orderAdditionalStuffDTOList.add(orderAdditionalStuffDTO1);
		 * 
		 * OrderAdditionalStuffDTO orderAdditionalStuffDTO2 = new
		 * OrderAdditionalStuffDTO("Paneer", "Veg Toppings", 35.0, 9);
		 * orderAdditionalStuffDTOList.add(orderAdditionalStuffDTO2);
		 * 
		 * OrderAdditionalStuffDTO orderAdditionalStuffDTO3 = new
		 * OrderAdditionalStuffDTO("Extra cheese", "miscellaneous", 35.0, 5);
...
//		orderPizzaDTO1.setOrderAdditionalStuffList(orderAdditionalStuffDTOList);
		...
		//Second Pizza starts 
		/*
		 * List<OrderAdditionalStuffDTO> orderAdditionalStuffDTOList2 = new
		 * ArrayList<>(); OrderAdditionalStuffDTO orderAdditionalStuffDTO21 = new
		 * OrderAdditionalStuffDTO("Black olive", "Veg Toppings", 20.0, 9);
		 * orderAdditionalStuffDTOList2.add(orderAdditionalStuffDTO21);
		 * 
		 * OrderAdditionalStuffDTO orderAdditionalStuffDTO24 = new
		 * OrderAdditionalStuffDTO("Grilled chicken", "Non-­Veg Toppings", 40.0, 5);
		 * orderAdditionalStuffDTOList2.add(orderAdditionalStuffDTO24);
		 * 
		 * OrderAdditionalStuffDTO orderAdditionalStuffDTO25 = new
		 * OrderAdditionalStuffDTO("Barbeque chicken", "Non-­Veg Toppings", 40.0, 5);
		 * orderAdditionalStuffDTOList2.add(orderAdditionalStuffDTO25);
		 * 
		 * OrderAdditionalStuffDTO orderAdditionalStuffDTO23 = new
		 * OrderAdditionalStuffDTO("Extra cheese", "miscellaneous", 35.0, 5);
