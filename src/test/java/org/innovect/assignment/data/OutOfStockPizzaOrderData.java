...
public class OutOfStockPizzaOrderData {
	...
	private static List<OrderPizzaDTO> createOrderPizzaDTOList(){
		...
		OrderPizzaDTO orderPizzaDTO2 = new OrderPizzaDTO("Out of Stock Pizza", PizzaInfoCategoryEnum.NON_VEGETARIAN.getCategory(), "Large", 425.00, "New hand tossed",
