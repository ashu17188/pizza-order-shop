...
public class NonVegWithPaneerRegular {
	...
	private static List<OrderPizzaDTO> createOrderPizzaDTOList(){
		...
		OrderPizzaDTO orderPizzaDTO1 = new OrderPizzaDTO("Deluxe Veggie", PizzaInfoCategoryEnum.NON_VEGETARIAN.getCategory(), "Regular", 150.00, "New hand tossed",
