...
public class VegPizzaNonVegToppingsOrderData {
	...
	private static List<OrderPizzaDTO> createOrderPizzaDTOList(){
		...
		OrderAdditionalStuffDTO orderAdditionalStuffDTO4 = new OrderAdditionalStuffDTO("Barbeque chicken", "Non-­Veg Toppings", 45.0, 5);
		...
		OrderAdditionalStuffDTO orderAdditionalStuffDTO22 = new OrderAdditionalStuffDTO("Paneer", "Veg Toppings", 35.0, 9);
		orderAdditionalStuffDTOList2.add(orderAdditionalStuffDTO22);
		...
		OrderPizzaDTO orderPizzaDTO2 = new OrderPizzaDTO("Non-­Veg Supreme", PizzaInfoCategoryEnum.NON_VEGETARIAN.getCategory(), "Medium", 325.00, "New hand tossed",
